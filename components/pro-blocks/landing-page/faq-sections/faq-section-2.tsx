              ...
              >
                ...
                <AccordionItem value="item-1">
                  <AccordionTrigger className="text-left">
                    How does Best Billing Co. join my meetings?
                  </AccordionTrigger>
                  <AccordionContent>
                    Best Billing Co. automatically joins your scheduled meetings
                    through calendar integration. Simply connect your calendar
                    (Google Calendar, Outlook, etc.) and Best Billing Co. will join
                    meetings at the scheduled time. You can also manually invite
                    Best Billing Co. to any meeting by adding our bot email to your
                ...
                <AccordionItem value="item-2">
                  <AccordionTrigger className="text-left">
                    What languages does Best Billing Co. support?
                  </AccordionTrigger>
                  <AccordionContent>
                    Best Billing Co. currently supports English, Spanish, French,
